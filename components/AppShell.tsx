...
export default function AppShell({
  ...
  return (
    <CartProvider>
      <Header initials={initials} businessName={businessName} logo={logo} announcementMessages={announcementMessages} />
      {children}
      <Footer businessName={businessName} initials={initials} whatsappNumber={whatsappNumber} />
      {whatsappNumber && (
        <a
