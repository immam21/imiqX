...
function CartView() {
  ...
  if (items.length === 0)
    return (
      <div className="mx-auto max-w-2xl px-4 pt-12 pb-28 text-center">
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 pb-32 pt-8 sm:px-6 animate-fade-up">
      {/* Header */}
      ...
      <div className="grid gap-6 lg:grid-cols-[1.7fr_0.85fr]">
        ...
        <div className="space-y-4">
          {items.map((it: CartItem) => (
            <div key={it.productId} className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-card transition-all animate-pop hover:shadow-hover">
        ...
        <aside className="space-y-5 lg:sticky lg:top-28 lg:self-start">
          <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="text-xl font-extrabold text-slate-900">₹{subtotal + 40}</span>
            </div>
            <a
              href="/checkout"
            ...
            <a href="/" className="mt-3 flex items-center justify-center gap-1.5 text-sm font-medium text-slate-400 transition hover:text-slate-900">
        ...
        <div className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-2xl">
          <div className="flex items-center justify-between gap-4 p-4">
            <div>
              ...
              <p className="text-xl font-extrabold text-slate-900">₹{subtotal + 40}</p>
            </div>
            <a
              href="/checkout"
